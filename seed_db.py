...
def seed_db():
    ...
    user = User(username='test', email='test@example.com', balance=2000)
    user.set_password('123')
    db.session.add(user)
    user2 = User(username='test2', email='test2@example.com', balance=2000)
    ...
    category = Category(name="Office_Supplies")
    ...
    item = Item(name='pens', price=3.00, quantity=30, seller=seller1, category="Office_Supplies")
    db.session.add(item)
    item2 = Item(name='books', price=0.90, quantity=400, seller=seller2, category ="Office_Supplies")
    ...
    item6 = Item(name='Pencil', price=.99, quantity=2, seller=seller1, category="Office_Supplies")
