...
class Reviews(db.Model):
    reviews = db.Table('reviews',
                       ...
                       db.Column('date_time', db.String(10), nullable=False),
                       db.Column('location', db.String(120)),
                       db.Column('stars', db.Integer, nullable=False),
                       db.Column('content', db.Text, primary_key=True))
...
class SellerReviews(db.Model):
    seller_reviews = db.Table('seller_reviews',
                              db.Column('user_id', db.Integer, db.ForeignKey('user.id'), primary_key=True),
                              db.Column('seller_id', db.Integer, db.ForeignKey('Seller.id'), primary_key=True),
                              db.Column('date_time', db.String(10), nullable=False),
                              db.Column('location', db.String(120)), db.Column('stars', db.Integer, nullable=False),
                              db.Column('content', db.Text, primary_key=True))
